...
The app will load all available checkpoints automatically and let you select which model to use at runtime.
...
This will download UTKFace via KaggleHub, organize images into the four age group folders (`18-24`, `25-39`, `40-59`, `60-plus`), and download FGNET for the regression experiments.
